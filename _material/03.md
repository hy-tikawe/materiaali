...
Yllä olevassa tiedostossa oleva avain on esimerkki, eikä sinun tule käyttää tätä avainta omassa sovelluksessasi vaan luoda oma salainen avain. Oman salaisen avaimen voi luoda vaikkapa Python-tulkin avulla. Esimerkiksi moduulin `secrets` funktio `token_hex` antaa halutun määrän satunnaisia tavuja:
