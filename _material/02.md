...
Tämä näyttää samat tiedot kuin sovelluksen lokissa mutta mukavammin luettavassa muodossa. Etuna on myös, että virheen sattuessa ei tarvitse mennä tutkimaan lokia vaan tiedot virheestä saa suoraan.
