...
Ensimmäinen rivi tarkoittaa, että selain pyysi sivun osoitteesta `/` eli sovelluksen etusivun. Tämän pyynnön yhteydessä näkyy HTTP-koodi 200, mikä tarkoittaa, että pyyntö oli onnistunut eli selain sai sovelluksen etusivun palvelimelta.
