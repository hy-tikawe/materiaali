...
Oletetaan lisäksi, että keskustelualue on verkossa osoitteessa `https://keskustelu.withmooc.fi`. Nyt hyökkääjä voi laatia omalleen sivulleen lomakkeen, jonka sisältö on seuraava: 

```html
<form action="https://keskustelu.withmooc.fi/new_message" method="post">
  <p>
...
Kuitenkin kun keskusteluun kirjautunut käyttäjä painaa napista, hän tulee lähettäneeksi keskusteluun seuraavan viestin:
