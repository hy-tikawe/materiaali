...
Äskeisessä lomakkeessa parametri on välitetty sivun osoitteessa `form`-elementin `action`-attribuutissa. Osoitteena on `{% raw %}/edit/{{ message.id }}{% endraw %}`, jolloin parametri `message.id` välittyy käsittelijälle.
