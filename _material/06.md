...
Koodi hakee kuvadatan tietokannasta ja lähettää sen selaimelle. Sisällön tyypiksi asetetaan `image/jpeg`, jotta selain osaa käsitellä datan kuvana. Kuva näytetään käyttäjäsivulla seuraavasti:
